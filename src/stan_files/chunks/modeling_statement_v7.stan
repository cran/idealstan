...
if (constrain_par == 1) {
  if (constraint_type == 1) {
    if (hier_type == 1 || hier_type == 4 || hier_type == 5 || hier_type == 7) {
      ...
      restrict_low ~normal(0, restrict_sd);
      #include "l_nonhier_prior.stan"
    ...
    if (hier_type == 1 || hier_type == 4 || hier_type == 5 || hier_type == 7) {
      ...
      //legis the same for all other hier_type combinations
      restrict_high ~normal(0, restrict_sd);
      #include "l_nonhier_prior.stan"
    ...
    if (hier_type == 1 || hier_type == 4 || hier_type == 5 || hier_type == 7) {
      ...
      restrict_high ~normal(legis_pred[1, (num_legis - (2 * num_constrain_l) + 1):(num_legis - num_constrain_l), ] * legis_x_cons, restrict_sd);
      restrict_low ~normal(legis_pred[1, (num_legis - num_constrain_l + 1):num_legis, ] * legis_x_cons, restrict_sd);
    ...
    if (hier_type == 1 || hier_type == 4 || hier_type == 5 || hier_type == 7) {
      //when restricting both, need to be very careful with how high and low restrictions are indexed
      pinned_pars ~normal(pin_vals, .01);
      #include "l_hier_prior.stan"
